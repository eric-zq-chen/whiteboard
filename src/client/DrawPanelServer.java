...
public class DrawPanelServer extends JPanel implements Serializable{
/**
	 * 
	 */
...
//		this.add(scroll);
	...
	public synchronized void copy(DrawPanelServer d) {
		image = d.image;
		if (image == null) {
	...
	public void drawData(shapeData sd) {
		...
		case LINE:
			...
			current = new Line(sd.x1, sd.y1, sd.x2, sd.y2, sd.color);
			current.draw(g2d);
			repaint();
